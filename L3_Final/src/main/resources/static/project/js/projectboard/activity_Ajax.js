    ...
    $.ajax({
        ...
        success: function(data) {
	        ...
	        for (var i = 0; i < data.length; i++) {
	            ...
	            } else if (rs.guide == '팀 권한 변경' && rs.update_DATA == '1') {
	            ...
	            } else if (rs.guide == '팀 권한 변경' && rs.update_DATA == '0') {

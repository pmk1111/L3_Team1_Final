...
.favorite-project, .setting, .project-name {
	display: inline-block;
}
...
.Chart Access {
	...
	transition: opacity 0.2s cubic-bezier(0.23, 1, 0.32, 1) 0s, visibility
		0.2s cubic-bezier(0.23, 1, 0.32, 1) 0s, transform 0.4s
		cubic-bezier(0.23, 1, 0.32, 1) 0s;
	background-color: rgb(255, 255, 255);
	border-width: 1px;
	border-radius: 4px;
	color: rgb(102, 102, 102);
	font: 14px/21px& amp; amp; amp; amp; amp; amp; amp; amp; amp; amp; quot;
	Microsoft YaHei&amp; amp; amp; amp; amp; amp; amp; amp; amp; amp; quot;;
	padding: 10px;
	top: 0px;
	left: 0px;
...
/* table */
.datatable-top>nav:first-child, .datatable-top>div:first-child,
...
.datatable-top>nav:last-child, .datatable-top>div:not(first-child),
...
.datatable-sorter.asc::before {
	border-top-color: #000 !important; /* darker arrow color */
}

.datatable-sorter.desc::after {
	border-bottom-color: #000 !important; /* darker arrow color */
}

.datatable-sorter.desc::before {
	border-top-color: #717171 !important; /* lighter arrow color */
}

.datatable-sorter.asc::after {
	border-bottom-color: #717171 !important; /* lighter arrow color */
}
...
.modal-close:hover {
	display: inline-block;
	background:
		url(../resources/project/img/projectboard/icon-minipop-close-hover.svg)
		no-repeat center/contain;
	width: 10px;
	height: 10px;
	position: absolute;
...
.color-option ul .project-color-check-active-1 a em {
	background: url(../resources/project/img/projectboard/icon-radio-on.svg)
...
.color-option ul li em {
	display: inline-block;
	background:
		url(../resources/project/img/projectboard/icon-radio-off.svg) center
		no-repeat;
...
.color-option ul li em:hover {
	display: inline-block;
	background:
		url(../resources/project/img/projectboard/icon-radio-hover.svg) center
		no-repeat;
	background-size: 22px;
	width: 22px;
	height: 22px;
...
<body>
                                    ...
                                    <div class="project-left">
                                        ...
                                        <a class="select-color"></a>
                                         ...
                                         <div class="modal-content">
            								<div class="modal-header">프로젝트 색상
														...
														<ul id="member-list-ul">
																...
																<div class="modal-member-info">
																	<div class="modal-member-profile">
																		<img class="modal-memeber-img"
																			src="../resources/project/img/projectboard/user3.jpg">
																	</div>
																	<div class="modal-member-name">
																		<a> <span class="modal-member-name-span">옥진석</span>
																		</a>
																	</div>
															...
															<li id="member-list-li">
																<div class="modal-member-info">
																	<div class="modal-member-profile">
																		<img class="modal-memeber-img"
																			src="../resources/project/img/projectboard/user4.jpg">
																	</div>
																	<div class="modal-member-name">
																		<a> <span class="modal-member-name-span">박민기</span>
																		</a>
																	</div>
																	<div class="modal-member-role">
																		<a href="#"
																			class="admin-invite-button-1 manager-badge"><span></span></a>
																	</div>
																	<!-- 관리자일때만 보이게 작업 -->
																	<div class="setting member-setting">
																		<div class="dropdown">
															...
															<li id="member-list-li">
																<div class="modal-member-info">
																	...
																	<div class="modal-member-name">
																		<a> <span class="modal-member-name-span">김주영</span>
																		</a>
																	</div>
																	<div class="modal-member-role">
																		<a href="#"
															...
															<li id="member-list-li">
																<div class="modal-member-info">
																	...
																	<div class="modal-member-name">
																		<a> <span class="modal-member-name-span">김혜원</span>
																		</a>
																	</div>
																	<div class="modal-member-role">
																		<a href="#"
															...
															<li id="member-list-li">
																<div class="modal-member-info">
																	...
																	<div class="modal-member-name">
																		<a> <span class="modal-member-name-span">한혜진</span>
																		</a>
																	</div>
																	<div class="modal-member-role">
																		<a href="#"
															...
															<li id="member-list-li">
																<div class="modal-member-info">
																	...
																	<div class="modal-member-name">
																		<a> <span class="modal-member-name-span">아이유</span>
																		</a>
																	</div>
																	<div class="modal-member-role">
																		<a href="#"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.modal-close-invite').click(function(event) {
                event.preventDefault();

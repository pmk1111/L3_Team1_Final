    ...
    <ul class="menu-inner py-1">
		...
		<li class="menu-item project-header" >
			<div class="menu-link" style="width: 100%; margin-left: -14px; height: 42.5px;">
			    <a class="menu-link company-link" href="${pageContext.request.contextPath}/admin/companyinfo" >
			            <i class="menu-icon tf-icons bx bx-buildings"></i>
			            <div data-i18n="Analytics">회사정보</div>
			    </a>
		    </div>
		</li>
        
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">구성원</span>
        </li>
        
        <li class="menu-item my-header">
        	<div class="menu-link" style="width: 100%; margin-left: -14px; height: 42.5px;">
	            <a href="${pageContext.request.contextPath}/admin/invite" class="menu-link invite-link">
	                <i class="menu-icon tf-icons bx bx-send"></i>
	                <div data-i18n="Tables">구성원 초대</div>
	            </a>
            </div>
        </li>
        ...
        <li class="menu-item">
          <div class="menu-link" style="width: 100%; margin-left: -14px; height: 42.5px;">
              <a href="${pageContext.request.contextPath}/admin/list" class="menu-link manage-link">
        ...
        <li class="menu-item">
          <div class="menu-link" style="width: 100%; margin-left: -14px; height: 42.5px;" >
              <a href="${pageContext.request.contextPath}/mainboard/my-dashboard" class="menu-link return-link">
                  ...
                  <div data-i18n="Layouts">돌아가기</div>
              </a>
          </div>
        </li>
       </div> 
